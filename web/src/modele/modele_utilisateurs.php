...
class Utilisateur{
  ...
  public function __construct($db){
        $this->db = $db;      
        $this->insert = $db->prepare("insert into utilisateurs(nom, prenom, pseudo, email, pass ,idrole ) values(:nom, :prenom, :pseudo, :email, :pass , :idrole )"); // 
...
pseudo=:pseudo");
  ...
  public function insert($nom, $prenom, $pseudo, $email, $pass, $idrole){
        $r = true;
        $this->insert->execute(array(':nom'=>$nom, ':prenom'=>$prenom, ':pseudo'=>$pseudo, ':email'=>$email, ':pass'=>$pass, ':idrole'=>$idrole));
