...
echo $twig->render('base.html.twig', array('liste'=>$liste));
}
...
$form = array();
 ...
 if ($exec){
 $form['valide'] = false;
 $form['message'] = 'Il y a eu un problème veuillez vérifier le contenu n\' oubliez pas que le contenu de résumé est limité à 255 caractère.';
 }
 else{
 $form['valide'] = true;
 $form['message'] = 'L\'actualité a été postée avec succès !';
